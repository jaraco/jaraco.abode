...
def device(
    ...
    return dump(
        ...
        status_ex='',
        actions=[
            {'label': 'Switch off', 'value': 'a=1&z=30&sw=off;'},
            {'label': 'Switch on', 'value': 'a=1&z=30&sw=on;'},
            {'label': 'Toggle', 'value': 'a=1&z=30&sw=toggle;'},
            {'label': '0%', 'value': 'a=1&z=30&sw=0;'},
            {'label': '10%', 'value': 'a=1&z=30&sw=10;'},
            {'label': '20%', 'value': 'a=1&z=30&sw=20;'},
            {'label': '30%', 'value': 'a=1&z=30&sw=30;'},
            {'label': '40%', 'value': 'a=1&z=30&sw=40;'},
            {'label': '50%', 'value': 'a=1&z=30&sw=50;'},
            {'label': '60%', 'value': 'a=1&z=30&sw=60;'},
            {'label': '70%', 'value': 'a=1&z=30&sw=70;'},
            {'label': '80%', 'value': 'a=1&z=30&sw=80;'},
            {'label': '90%', 'value': 'a=1&z=30&sw=90;'},
            {'label': '100%', 'value': 'a=1&z=30&sw=99;'},
        ],
        status_icons=[],
        statusEx='37',
