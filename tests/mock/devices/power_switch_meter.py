"""Mock Abode Power Switch Meter Device."""
import jaraco.abode.helpers.constants as CONST

from .. import dump


DEVICE_ID = 'ZW:00000077'
...
def device(
    ...
    return dump(
        id=devid,
        type_tag='device_type.power_switch_meter',
        type='Power Switch Meter',
        name='Aeon Switch',
        area='1',
        zone='32',
        sort_order=None,
        ...
        capture_mode=None,
        origin='abode',
        control_url='api/v1/control/power_switch/ZW:00000077',
        deep_link=None,
        status_color='#5cb85c',
        faults={
