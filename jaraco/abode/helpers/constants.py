...
PANEL_SETTINGS = [
    SETTING_CAMERA_RESOLUTION,
    SETTING_CAMERA_GRAYSCALE,
...
AREA_SETTINGS = [
    SETTING_ENTRY_DELAY_AWAY,
    SETTING_EXIT_DELAY_AWAY,
    SETTING_ENTRY_DELAY_HOME,
    SETTING_EXIT_DELAY_HOME,
]
...
SOUND_SETTINGS = [
    SETTING_DOOR_CHIME,
    SETTING_WARNING_BEEP,
    SETTING_ENTRY_BEEP_AWAY,
    SETTING_EXIT_BEEP_AWAY,
    SETTING_ENTRY_BEEP_HOME,
    SETTING_EXIT_BEEP_HOME,
    SETTING_CONFIRM_SOUND,
    SETTING_ALARM_LENGTH,
    SETTING_FINAL_BEEPS,
]
...
SIREN_SETTINGS = [
    SETTING_SIREN_ENTRY_EXIT_SOUNDS,
    SETTING_SIREN_TAMPER_SOUNDS,
...
SETTING_ALL_CAMERA_RES = [SETTING_CAMERA_RES_320_240, SETTING_CAMERA_RES_640_480]
...
ALL_SETTING_ENTRY_EXIT_DELAY = [
    SETTING_ENTRY_EXIT_DELAY_DISABLE,
...
ALL_SETTING_ALARM_LENGTH = [
    SETTING_ALARM_LENGTH_DISABLE,
...
ALL_SETTING_FINAL_BEEPS = [
    SETTING_FINAL_BEEPS_DISABLE,
    SETTING_FINAL_BEEPS_3SEC,
    SETTING_FINAL_BEEPS_4SEC,
    SETTING_FINAL_BEEPS_5SEC,
    SETTING_FINAL_BEEPS_6SEC,
    SETTING_FINAL_BEEPS_7SEC,
    SETTING_FINAL_BEEPS_8SEC,
    SETTING_FINAL_BEEPS_9SEC,
    SETTING_FINAL_BEEPS_10SEC,
]
